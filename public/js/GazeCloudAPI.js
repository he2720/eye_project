...
if( document.getElementById("AllowCamInfo") !=  null)
   ...
   var ForeceCloudServerAdress  = false;
    ...
    //------------------------------
     ...
     return;
      ...
      var myJSON = JSON.stringify(vConnectHistory);
        var url = 'https:/ .gazerecorder.com/GetCloudAdress/?vConnectHistory='+ myJSON;;
    ...
    function GetCloudAdress() {
        ...
        var url = 'https:/ .gazerecorder.com/GetCloudAdress/';
        let req = new XMLHttpRequest();
        let formData = new FormData();
        req.open("GET", url);
        req.onload = function() {
...
if( document.getElementById("InvalidCalibrationInfo") !=  null)
    ...
    {
        try {
            var style = '<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"> <link rel="stylesheet" href="https:/ .gazerecorder.com/GazeCloudAPI.css" >';
